    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[12.5%] right-[12.5%] h-px bg-linear-to-r from-transparent via-blue-500/30 to-transparent" />
                ...
                <div key={s.step} className="relative text-center group">
                  ...
                  {i < steps.length - 1 && (
                    <div className="lg:hidden flex justify-center mt-6 mb-2">
                      <div className="w-px h-8 bg-linear-to-b from-blue-500/30 to-transparent" />
                    </div>
                  )}
                </div>
              );
