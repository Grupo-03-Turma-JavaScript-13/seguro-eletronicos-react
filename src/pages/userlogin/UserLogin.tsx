...
// Mock de usuários cadastrados no backend
const MOCK_USERS = [
    { id: "1", usuario: "admin", senha: "123456", email: "admin@rivertech.com", nome: "Admin RiverTech" },
    { id: "2", usuario: "joao", senha: "senha123", email: "joao@rivertech.com", nome: "João Silva" },
    { id: "3", usuario: "maria", senha: "senha456", email: "maria@rivertech.com", nome: "Maria Santos" },
];
...
export default function UserLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Mock: aceita qualquer usuário que exista na lista
      ...
      if (user) {
        ...
        setError("Usuário não encontrado. Tente: admin, joao ou maria");
        setIsLoading(false);
      }
    }, 1000);
  };
