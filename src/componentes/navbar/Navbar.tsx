      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              href="/signup"
              className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25"
            >
              Proteger Agora
            </a>
          </div>
        ...
        {mobileOpen && (
          <div className="lg:hidden border-t border-white/10 py-4 space-y-1">
            ...
            <div className="pt-3 border-t border-white/10 space-y-2">
              ...
              <a
                href="/signup"
                className="block w-full text-center px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-lg transition-all"
                onClick={() => setMobileOpen(false)}
              >
                Proteger Agora
              </a>
